...
class _CustomAppBarState extends State<CustomAppBar> {
  ...
  void initState() {
    super.initState();
    // قراءة النجوم: نُحدِّث المُخطِر الحيّ فوراً من الكاش، ثم نُزامن مع السيرفر.
    _refreshStars();
  }

  Future<void> _refreshStars() async {
    // حمّل القيمة المخزنة محلياً أولاً لعرض فوري (تجنّب وميض الصفر)…
    await ScoreManager.loadCachedIntoNotifier();
    // …ثم زامِن مع السيرفر (يصحّح القيمة إن اختلف).
    if (mounted) await ScoreManager.getStars();
  }
