    ...
    if (_currentLevelIndex < _levels.length - 1) {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text("لقد أتقنت تركيب الأسئلة بالإنجليزية وحصلت على 50 نجمة! ⭐", textAlign: TextAlign.center),
