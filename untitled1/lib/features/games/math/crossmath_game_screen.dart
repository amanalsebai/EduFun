...
class _CrossMathGameScreenState extends State<CrossMathGameScreen> {
  ...
  Widget _buildMascotHint() => Row(crossAxisAlignment: CrossAxisAlignment.end, children: [Container(width: 90, height: 90, margin: const EdgeInsets.only(bottom: 10), child: Image.network("https://lh3.googleusercontent.com/aida-public/AB6AXuBAXbxGXWMuj7b9IZ54TJ7A_FbOhhCx5g9Y3lA_TVLDf-vhTaolru69KoixmGB-c9oiVE4BEqZj92oqEG_fTthlYJfOFVl-5KgfbLZ0G29lfyNTrKExOyqBGjX7QV524lrcJyvq3XwjBTTMF-FrUXjSsBO8cpONcVV6-MmhSIRHWGwh0RuxpeJbCPV-B2BahgbI7g1gWEtzD9ffM8o-qFo7KZvbk-KHwq0SUuxXvTq7XFQm7xw5C6R1azMTc3RnOTfQrEA8aRe9JFGF", fit: BoxFit.contain)), const SizedBox(width: 8), Expanded(child: Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.white.withOpacity(0.85), borderRadius: const BorderRadius.only(topLeft: Radius.circular(20), topRight: Radius.circular(20), bottomLeft: Radius.circular(20)), border: Border.all(color: Colors.white.withOpacity(0.5), width: 2), boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 10)]), child: const Text("\"مرحباً! حاول سحب الرقم ٥ إلى المربع الفارغ لحل المعادلتين معاً.\"", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppColors.onSurface, height: 1.4))))]);
