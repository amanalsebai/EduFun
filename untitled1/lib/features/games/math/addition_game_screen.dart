...
class _AdditionGameScreenState extends State<AdditionGameScreen> {
  ...
  void _generateLevels() {
    final random = Random();
    for (int i = 0; i < 5; i++) {
      _levels.add(MathLevel(num1: random.nextInt(10) + 1, num2: random.nextInt(10) + 1));
    }
  }
